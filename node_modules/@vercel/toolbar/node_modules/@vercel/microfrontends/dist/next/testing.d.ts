...
import { M as MicrofrontendConfigIsomorphic } from '../index-2b59c627.js';
...
declare function getExpectedDomainForApp(mfConfig: MicrofrontendConfigIsomorphic, appName: string, env: string): string;
/**
...
export { expandWildcards, getAllChildApplicationNames, getAllMicrofrontendPaths, getExpectedDomainForApp, getFlaggedPathsForApp, getLaunchedPathsForApp, loadMicrofrontendConfigForEdge, validateMiddlewareConfig, validateMiddlewareOnFlaggedPaths };
